...
public class ExpenseSpinnerCatAdapter1 extends BaseAdapter{

    private ArrayList<CatItemData>expenseItemDataArrayList;
    private Context context;
    LayoutInflater layoutInflater;

    public ExpenseSpinnerCatAdapter1(ArrayList<CatItemData> expenseItemDataArrayList, Context context) {
